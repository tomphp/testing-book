...
<Section title="Why Test">
  <p>
    When building <em>software systems</em>, we want enough tests to give us the <strong>confidence</strong>
    to deploy to production. While <a href="/glossary#continuous-deployment">Continuous Deployment</a> might
...
<Section title="Approach">
  ...
  <p>
    ...
    each. Often, a better approach to testing will be to change your system architecture; we will advocate for these
    techniques but will also present alternatives for when it is not possible.
  </p>
</Section>
